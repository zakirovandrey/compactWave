...
inline __host__ __device__ float4 operator+(float4 a) { return a; }
inline __host__ __device__ float4 operator-(float4 a) { return make_float4(-a.x,-a.y,-a.z,-a.w); }
...
// char3
inline __host__ __device__ char3 operator+(char3 a,char3 b) { return make_char3(a.x + b.x, a.y + b.y, a.z + b.z); }
inline __host__ __device__ char3 operator+(char3 a,char b) { return make_char3(a.x + b, a.y + b, a.z + b); }
